...
\midrule
\textbf{Sub-Pods per Pod} & MDI architecture: 13 Dunbar Sub-Pods per Pod & 13 \\
\textbf{Residents per Sub-Pod} & MDI pod specification: 12 per Dunbar Sub-Pod & 12 \\
\textbf{Total residents per Pod} & 13 Sub-Pods $\times$ 12 residents & 156 \\
