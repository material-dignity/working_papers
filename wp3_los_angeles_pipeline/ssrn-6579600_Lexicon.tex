...
\paragraph{Dunbar Sub-Pod (DSP)} An ITP-assigned social cluster within a Dunbar Pod. Sizing is standardized at twelve individuals. All residents stabilize within these uniform clusters. DSP assignment remains fixed to guarantee relational continuity as the resident stabilizes.
...
\paragraph{IMD Exclusion (Institution for Mental Disease)} The federal Medicaid rule excluding federal financial participation for mental health facilities with more than 16 beds. Resolved architecturally by the fifteen-unit MHRC cluster structure: each cluster falls below the threshold and files independently. No waiver required.
...
\rowcolor{rowgray}
DSP      & Dunbar Sub-Pod                             & NIMBY   & Not In My Backyard \\
